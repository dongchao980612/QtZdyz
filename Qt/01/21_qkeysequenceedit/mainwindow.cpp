    ...
    : QMainWindow(parent)
{
    ...
    /* 信号槽连接 */
    connect(keySequenceEdit, &QKeySequenceEdit::keySequenceChanged, this, &MainWindow::keySequenceEditKeySequenceChanged);
...
void MainWindow::keySequenceEditKeySequenceChanged(
