    ...
    : QMainWindow(parent)
{
    ...
    /* 信号槽连接 */
    connect(horizontalSlider, &QSlider::valueChanged, this, &MainWindow::horizontalSliderValueChanged);
    connect(verticalSlider, &QSlider::valueChanged, this, &MainWindow::verticalSliderValueChanged);
