    ...
    , ui(new Ui::MainWindow)
{
    ...
    /* 信号槽连接 */
    connect(pushButton1,  &QPushButton::clicked, this,  &MainWindow::pushButton1_Clicked);
    connect(pushButton2,  &QPushButton::clicked, this,  &MainWindow::pushButton2_Clicked);
}
