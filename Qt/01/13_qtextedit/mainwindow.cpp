    ...
    : QMainWindow(parent)
{
    ...
    /* 信号槽连接 */
    connect(pushButtonSelectAll, &QPushButton::clicked, this, &MainWindow::pushButtonSelectAllClicked);
    connect(pushButtonClearAll,  &QPushButton::clicked, this, &MainWindow::pushButtonClearAllClicked);
