...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent)
{
    this->setGeometry(50, 50, 800, 480);
    ...
    void (MainWindow::*doubleSpinBoxValueChangedSlot)(double) = &MainWindow::doubleSpinBoxValueChanged;
    connect(doubleSpinBox, valueChangedSignal, this, doubleSpinBoxValueChangedSlot);
